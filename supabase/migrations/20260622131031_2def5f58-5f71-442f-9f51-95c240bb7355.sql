...
BEGIN
  ...
  -- Desliga triggers da sessão: estamos mudando apenas representante_id,
  -- nenhum trigger financeiro/vigência precisa rodar e fn_manter_vigente
  -- recursiona em notas com codigo_nota repetido (estouro de pilha).
