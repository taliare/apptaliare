...
BEGIN
  ...
  IF array_length(v_ids, 1) IS NOT NULL THEN
    ...
    -- NOTA: pagamentos_historico NÃO é atualizado de propósito — os pagamentos já recebidos
    -- pertencem ao representante que os recebeu (preserva caixa diário antigo e evita
    -- recursão via fn_sincronizar_cobranca_apos_historico).
  END IF;
